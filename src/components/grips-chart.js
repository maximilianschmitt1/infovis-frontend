  ...
  render() {
    ...
    return (
      <Chart
        ...
        options={{ scaleBeginAtZero : true, bezierCurve: false, scaleFontSize: 16, maintainAspectRatio: false, responsive: true, animation: false, multiTooltipTemplate: '<%= datasetLabel %>: <%= value %>' }}
        />
    );
